package hridoy.aiz.sharedpreference;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences pref_data = getSharedPreferences(MY_PREFS_FILENAME, MODE_PRIVATE);
        String user = pref_data.getString("user", "");
